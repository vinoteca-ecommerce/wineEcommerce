    ...
    <div className={style.containerAllPerfil}>
      <form onSubmit={handleSubmit}>
             ...
             <div className={style.namediv}>
                        <label className={style.labelname}>{input.name} <Button onClick={e=>handleEdit(e)}><EditIcon  style={{color:'#6c0000'}}/></Button></label>
                        {nombre === false ? <div>
                        </div>: (
                    ...
                    <label className={style.role}>{user.role}</label>
                    </div>
